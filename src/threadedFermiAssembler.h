...
/*
 *  This is a copy of SeqLib's FermiAssembler.h, with the addition of being able to
 *  enable multithreading
 */

#ifndef PISA_FERMIASSEMBLER_H
#define PISA_FERMIASSEMBLER_H
...
namespace Pisa {
    ...
    public:
         ...
         */
        void AddReads(const SeqLib::BamRecordVector& brv);
         ...
         */
        SeqLib::UnalignedSequenceVector GetSequences() const;
        ...
        void AddReads(const SeqLib::UnalignedSequenceVector& v);

        /** Add a single sequence to be assembled */
        void AddRead(const SeqLib::UnalignedSequence& r);
        ...
        /** KG added: Enable multithreading */
        void SetThreads(int threads) { opt.n_threads = threads; }
